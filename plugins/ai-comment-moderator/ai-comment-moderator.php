 ...
 * Description: AI-powered comment moderation using Ollama to automatically detect and handle spam, rude, or inappropriate comments
 * Version: 1.0.0
 * Author: Your Name
 */
...
define('AI_COMMENT_MODERATOR_VERSION', '1.0.0');
