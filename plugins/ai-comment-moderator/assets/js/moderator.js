    ...
    function logBatchResults(results) {
        ...
        $.each(results.details, function(index, detail) {
            ...
            var message = result.success ? 
                'Comment ' + detail.comment_id + ': ' + result.decision + ' → ' + result.action :
                'Comment ' + detail.comment_id + ': Error - ' + result.error;
            
            $log.append('<div class="log-entry ' + logClass + '">' + message + '</div>');
        });
