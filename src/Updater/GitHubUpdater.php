...
namespace GraylogSearch\Updater;
...
class GitHubUpdater {
	...
	private function __construct() {
		...
		$this->github_repo     = 'DroppedLink/Graylog-Search';
		...
		add_action( 'wp_ajax_graylog_check_updates', array( $this, 'ajax_check_updates' ) );
	}
	 ...
	 *
	 * @param false|object|array $false  Default false.
	...
	private function get_github_release_info() {
		...
		$data = array(
			...
			'changelog'    => ! empty( $release['body'] ) ? $release['body'] : __( 'See GitHub release for details.', 'graylog-search' ),
		);
	...
	public function ajax_check_updates() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_send_json_error( esc_html__( 'Insufficient permissions.', 'graylog-search' ) );
		}
